...
public class AdminTravelRepository {
    ...
    public List<AdminTravelDTO> findTravelsList(Map<String, Object> travelMap) {
        ...
        return TravelMapper.INSTANCE.toDtoList(travelList);
    }
     ...
     * </pre>
     */
    public AdminTravelDTO findOneTravel(Map<String, Object> travelMap) {
        ...
        return TravelMapper.INSTANCE.toDto(findOneTravel);
    }
}
